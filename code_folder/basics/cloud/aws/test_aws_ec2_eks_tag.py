...
class TestDeleteUnusedEbs(unittest.TestCase):
    def setUp(self):
        ...
        self.volume1 = {
            "VolumeId": "vol-123",
            "Tags": {"Name": "my-volume", "Owner": "anansi"},
        }
        self.volume2 = {
            "VolumeId": "vol-456",
            "Tags": {"Name": "another-volume", "Owner": "anansi"},
        }
        self.volume3 = {
            "VolumeId": "vol-789",
            "Tags": {"Name": "unused-volume", "Owner": "anansi"},
        }
    ...
    def test_delete_unused_ebs_with_error(self):
        self.ec2_mock.describe_volumes.side_effect = ClientError(
            {"Error": {}}, "operation"
        )
