...
def hyperparameter_tuning_pipeline(
    ...
    train_op = components.load_component_from_url('https://raw.githubusercontent.com/kubeflow/pipelines/master/components/kubeflow/tf-train/component.yaml')
    eval_op = components.load_component_from_url('https://raw.githubusercontent.com/kubeflow/pipelines/master/components/kubeflow/tf-job-bare/component.yaml')
